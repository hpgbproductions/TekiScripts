namespace Assets.Scripts.Levels.Common.Defend2
{
   using System;
   ...
   /// <summary>
   /// A script that monitors multiple targets to protect, setting a flag when one is destroyed.
   /// </summary>
   /// <seealso cref="UnityEngine.MonoBehaviour" />
   public class ProtectionStrictMonitorScript : MonoBehaviour
   {
      /// <summary>
      ...
      /// </value>
      public bool AnyProtectionDestroyed { get; private set; }
      ...
      /// </value>
      public int ProtectCriticalTotalCount
      {
         get
         {
            return
      ...
      private IEnumerator MonitorLevelObjectivesCoroutine()
      {
         while (true)
         {
            ...
            if (anyDestroyed)
            {
               this.AnyProtectionDestroyed = true;
               ////break;
            }
         }
      }
